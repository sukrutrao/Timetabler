 ...
 *
 * @param[in]  name        The name of the Program, which uniquely identifies it.
 *                         For example, it could be "B Tech 1".
...
/**
 * @brief      Checks if two Program objects are identical, which is whether they
 *             have the same name and course type.
 *
